...
public class Level3 extends World
{
    ...
    private void setup()
    {
        ...
        gruenerpunkt = new GruenerPunkt();
        addObject(gruenerpunkt, 290, 60);
        
        mover = new Mover();
        addObject(mover, 350, 300);
    }
    ...
    public void act()
    {
        ...
        blauerpunkt4.bewege(500, 590);
        gruenerpunkt.bewege(10, 85);
        mover.pulse(1);
        showText("Level: 3", 40, 10);
